...
| `fetch`   |    ✖     | A custom `fetch` implementation to use for all requests. Useful for proxies, custom agents, retries, or non-global-fetch runtimes. Defaults to `globalThis.fetch`.                             |
